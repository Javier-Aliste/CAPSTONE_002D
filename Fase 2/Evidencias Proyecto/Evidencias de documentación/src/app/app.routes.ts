...
export const routes: Routes = [
  ...
  {
    path: 'conversaciones',
    loadComponent: () => import('./pages/conversaciones/conversaciones.page').then( m => m.ConversacionesPage)
  },
  {
    path: 'verperfil',
    loadComponent: () => import('./pages/verperfil/verperfil.page').then( m => m.VerperfilPage)
  },
